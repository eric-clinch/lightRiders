...
public class GetMovesABCTKillerPartitionTreeSize implements GetMoves{
	...
	public GetMovesABCTKillerPartitionTreeSize(Evaluator evaluator, GetSearchNumberWithTreeSize getSearchDepth){
